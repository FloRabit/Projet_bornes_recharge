...
demande_iris = 30  # Demande pour chaque parcelle IRIS de 2000 habitants. Uniforme pour simplification
p = 1500  # Nombre maximal de centres
...
if __name__ == "__main__":
    ...
    print("Nombre de sites sélectionnés :", len(selected_sites))
